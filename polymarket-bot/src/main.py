...
DYNAMO_URL        = os.getenv("AMF_COORDINATOR_URL", "")
LMCACHE_URL       = os.getenv("KORITH_LMCACHE_URL", "")
...
class Orchestrator:
    ...
    def _build_strategies(self) -> list:
        s = [
            ...
            MarketMakingStrategy(self.amf, self.poly),
            LagArbitrageStrategy(self.feed, self.poly),
            MeanReversionStrategy(self.feed, self.amf, self.poly),
